...
class NearEarthObject:
    ...
    def __init__(self, **info):
        ...
        self.name = info["name"] if info.get("name") else None
...
class CloseApproach:
    ...
    def __init__(self, **info):
        ...
        self.time = cd_to_datetime(info["time"]) if info.get("time") else None 
    ...
    @property
    def neo_name(self):
        return self.neo.fullname or None
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return (f"At time {self.time_str}, {self.neo_name} approaches Earth at a distance of "
